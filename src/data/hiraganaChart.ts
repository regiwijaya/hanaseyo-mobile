...
export const hiraganaChartRows: HiraganaChartRow[] = [
  ...
  },
  {
    ...
    title: "が行",
    subtitle: "Dakuten G",
    lessonId: "hiragana-ga-row",
    cells: [
      { kana: "が", reading: "ga", audioText: "が" },
      { kana: "ぎ", reading: "gi", audioText: "ぎ" },
      { kana: "ぐ", reading: "gu", audioText: "ぐ" },
      { kana: "げ", reading: "ge", audioText: "げ" },
      { kana: "ご", reading: "go", audioText: "ご" },
    ],
  },
  {
    id: "za-row",
    title: "ざ行",
    subtitle: "Dakuten Z",
    lessonId: "hiragana-za-row",
    cells: [
      { kana: "ざ", reading: "za", audioText: "ざ" },
      { kana: "じ", reading: "ji", audioText: "じ" },
      { kana: "ず", reading: "zu", audioText: "ず" },
      { kana: "ぜ", reading: "ze", audioText: "ぜ" },
      { kana: "ぞ", reading: "zo", audioText: "ぞ" },
    ],
  },
  {
    id: "da-row",
    title: "だ行",
    subtitle: "Dakuten D",
    lessonId: "hiragana-da-row",
    cells: [
      { kana: "だ", reading: "da", audioText: "だ" },
      { kana: "ぢ", reading: "ji", audioText: "ぢ" },
      { kana: "づ", reading: "zu", audioText: "づ" },
      { kana: "で", reading: "de", audioText: "で" },
      { kana: "ど", reading: "do", audioText: "ど" },
    ],
  },
  {
    id: "ba-row",
    title: "ば行",
    subtitle: "Dakuten B",
    lessonId: "hiragana-ba-row",
    cells: [
      { kana: "ば", reading: "ba", audioText: "ば" },
      { kana: "び", reading: "bi", audioText: "び" },
      { kana: "ぶ", reading: "bu", audioText: "ぶ" },
      { kana: "べ", reading: "be", audioText: "べ" },
      { kana: "ぼ", reading: "bo", audioText: "ぼ" },
    ],
  },
  {
    id: "pa-row",
    title: "ぱ行",
    subtitle: "Handakuten P",
    lessonId: "hiragana-pa-row",
    cells: [
      { kana: "ぱ", reading: "pa", audioText: "ぱ" },
      { kana: "ぴ", reading: "pi", audioText: "ぴ" },
      { kana: "ぷ", reading: "pu", audioText: "ぷ" },
      { kana: "ぺ", reading: "pe", audioText: "ぺ" },
      { kana: "ぽ", reading: "po", audioText: "ぽ" },
    ],
  },
];