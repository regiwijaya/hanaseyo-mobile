...
import {
  KatakanaChartCell,
  katakanaChartColumns,
  katakanaChartRows,
} from "../data/katakanaChart";
import { RootStackParamList } from "../navigation/types";
import { colors } from "../theme/colors";
import { spacing } from "../theme/spacing";

type Props = NativeStackScreenProps<RootStackParamList, "KatakanaChart">;

export function KatakanaChartScreen({ navigation }: Props) {
  ...
  function renderCell(cell: KatakanaChartCell, index: number) {
    if (!cell) {
      return (
  ...
  return (
    <ScreenContainer>
      <SectionHeader
        title="Tabel Katakana"
        subtitle="Tekan setiap huruf untuk mendengar bunyinya. Katakana banyak digunakan untuk kata serapan dan nama asing."
      />
      ...
      <AppCard>
        ...
        <AppText color={colors.textMuted} style={styles.helpText}>
          ...
          memiliki semua kolom, misalnya ヤ行 dan ワ行.
        </AppText>

        <View style={styles.columnHeader}>
          <View style={styles.rowLabelSpacer} />

          {katakanaChartColumns.map((column) => (
